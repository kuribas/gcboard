...
void
g_cclosure_user_marshal_BOOLEAN__INT_INT_INT_INT_INT_INT (GClosure     *closure,
                                                          GValue       *return_value,
                                                          guint         n_param_values,
                                                          const GValue *param_values,
                                                          gpointer      invocation_hint,
                                                          gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__INT_INT_INT_INT_INT_INT) (gpointer     data1,
                                                                     gint         arg_1,
                                                                     gint         arg_2,
                                                                     gint         arg_3,
                                                                     gint         arg_4,
                                                                     ...
                                                                     gint         arg_6,
                                                                     gpointer     data2);
  register GMarshalFunc_BOOLEAN__INT_INT_INT_INT_INT_INT callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gboolean v_return;
  ...
  callback = (GMarshalFunc_BOOLEAN__INT_INT_INT_INT_INT_INT) (marshal_data ? marshal_data : cc->callback);
